	...
	if(isset($_POST['submit']))
	{
    	...
    	if( check_fields($_POST,$missing)==true )
    	{
    		if( check_accomodation_value($_POST['accomodation'],$missing)==true)
    		{
    			...
    			$sql = "INSERT INTO register(`first_name`,`last_name`,`email_id`,`college`,`accomodation`) 
    			        VALUES(
    			        	'".$_POST['first_name']."',
    			        	'".$_POST['last_name']."',
    			        	'".$_POST['email_id']."',
		...
		<div class="blocks">
            ...
            <form name='registration' action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  >
	            <div id="container">
	              ...
	              <div class="message">* Online Registrations will be started from 10th of april.</div>
				  <div class="labels">
				    <div id="fName_label"><label for="first_name">First Name:</label></div>
				    <div id="lName_label"><label for="last_name">Last Name:</label></div>
				    <div id="email_label"><label for="email_id">Email id:</label></div>
				  ...
				  <?php
				   if($successful==false){  
				   		...
				   		{
				   ?>
				   		<div class="warning">Online Registrations will be started from 10th of april.</div>
				   	<?php }?>
